 ...
 * @author AdminEtu
 */
@WebServlet(name = "UpdateUserLevel", urlPatterns = {"/UpdateUserLevel"})
public class UpdateUserLevel extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            ps.executeUpdate("UPDATE USER SET LEVEL = '" + level + "' WHERE ID = " + Integer.parseInt(id));

            /* TODO output your page here. You may use following sample code. */
            out.println("<!DOCTYPE html>");
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet UpdateUserLevel</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>User update id = " + id + "</h1>");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(UpdateUserLevel.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
